...
%% Run Building Simulation  MPC with oc and bat
% Use GA to solve MPC

[AcPowerMPCocMIP, TzoneMPCocMIP, batenergyMPCoc, batchargseqMPCoc, BillMPCocB]= SIP_MPC_Amin_oc_bat_x(Qinternal,T,IDIRW,IDIRE,IDIRN,IDIRS,IDIR,Tset,rnw,north,rsw,south,rew,east,rww,west,floor,roof,price);
...
ylabel('W','FontSize',16,'color','black');
legend('MPC with occupancy and MIP');
