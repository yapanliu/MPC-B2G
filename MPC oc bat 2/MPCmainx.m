...
BillMPCocAC1= sum(AcPowerMPCocbx1(1:250).*price(1:250)/500000)
...
BillMPCocAC2= sum(AcPowerMPCocbx2(1:250).*price(1:250)/500000)
...
BillMPCocACw1= sum(AcPowerMPCocbxw1(1:250).*price(1:250)/500000)
...
BillMPCocACw2= sum(AcPowerMPCocbxw1(1:250).*price(1:250)/500000)
